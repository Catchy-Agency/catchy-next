...
export interface AllCaseStudies_primaryPage_blocks_ServicePanelSetRecord {
...
export interface AllCaseStudies_primaryPage_blocks_BannerRecord_foregroundImage_responsiveImage {
  readonly __typename: "ResponsiveImage";
  readonly aspectRatio: any;
  readonly height: any;
  readonly width: any;
...
export interface AllCaseStudies_primaryPage_blocks_BannerRecord_foregroundImage {
  readonly __typename: "FileField";
  readonly responsiveImage: AllCaseStudies_primaryPage_blocks_BannerRecord_foregroundImage_responsiveImage | null;
}
...
export interface AllCaseStudies_primaryPage_blocks_BannerRecord {
  ...
  readonly text: string | null;
  readonly foregroundImage: AllCaseStudies_primaryPage_blocks_BannerRecord_foregroundImage | null;
...
export type AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord_links = AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord_links_CaseStudyRecord | AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord_links_PrimaryPageRecord | AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord_links_BlogPostRecord | AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord_links_ContentPageRecord | AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord_links_DownloadPageRecord;
...
export type AllCaseStudies_primaryPage_blocks = AllCaseStudies_primaryPage_blocks_ServicePanelSetRecord | AllCaseStudies_primaryPage_blocks_AgencyModelRecord | AllCaseStudies_primaryPage_blocks_BannerRecord | AllCaseStudies_primaryPage_blocks_ButtonExternalRecord | AllCaseStudies_primaryPage_blocks_ButtonInternalRecord | AllCaseStudies_primaryPage_blocks_ClientSetRecord | AllCaseStudies_primaryPage_blocks_ContentLinkSetRecord | AllCaseStudies_primaryPage_blocks_ColumnRowRecord | AllCaseStudies_primaryPage_blocks_FormBlockRecord | AllCaseStudies_primaryPage_blocks_FormulaRecord | AllCaseStudies_primaryPage_blocks_ImageSetRecord | AllCaseStudies_primaryPage_blocks_RichTextRecord | AllCaseStudies_primaryPage_blocks_ServiceSetRecord | AllCaseStudies_primaryPage_blocks_TeamRecord | AllCaseStudies_primaryPage_blocks_TitleTextRecord | AllCaseStudies_primaryPage_blocks_VideoRecord | AllCaseStudies_primaryPage_blocks_VideoInternalRecord | AllCaseStudies_primaryPage_blocks_ViewMoreLinkRecord;
