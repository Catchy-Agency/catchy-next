...
export type ContentPageBySlug_contentPage_blocks_ButtonInternalRecord_link =
  | ContentPageBySlug_contentPage_blocks_ButtonInternalRecord_link_ContentPageRecord
  | ContentPageBySlug_contentPage_blocks_ButtonInternalRecord_link_BlogPostRecord
...
export type ContentPageBySlug_contentPage_blocks_ColumnRowRecord_columns_blocks_ButtonInternalRecord_link =
  ...
  | ContentPageBySlug_contentPage_blocks_ColumnRowRecord_columns_blocks_ButtonInternalRecord_link_BlogPostRecord
...
export type ContentPageBySlug_contentPage_blocks_ColumnRowRecord_columns_blocks =
  | ContentPageBySlug_contentPage_blocks_ColumnRowRecord_columns_blocks_ImageSetRecord
...
export type ContentPageBySlug_contentPage_blocks_ContentLinkSetRecord_links =
  | ContentPageBySlug_contentPage_blocks_ContentLinkSetRecord_links_PrimaryPageRecord
  | ContentPageBySlug_contentPage_blocks_ContentLinkSetRecord_links_BlogPostRecord
...
export type ContentPageBySlug_contentPage_blocks =
  | ContentPageBySlug_contentPage_blocks_ButtonExternalRecord
  | ContentPageBySlug_contentPage_blocks_ButtonInternalRecord
  | ContentPageBySlug_contentPage_blocks_ColumnRowRecord
  | ContentPageBySlug_contentPage_blocks_ContentLinkSetRecord
  | ContentPageBySlug_contentPage_blocks_ImageSetRecord
